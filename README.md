...
- **Qwen3.6-35B-A3B (高智商、超快速 Sparse MoE 量化版本)**：
...
- **Qwen-3.6 35B MoE**: Port `8084` (基于 35B Sparse MoE，激活仅 3B，速度极快)
...
# Start the Qwen-3.6 35B MoE server
...
- **切换到 Qwen3.6 35B MoE 模型 (推荐，速度极快，智能体推荐)**：
